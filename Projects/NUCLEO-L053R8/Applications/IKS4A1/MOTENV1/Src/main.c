...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin_Pin|SPI1_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI1_CS_Pin_Pin SPI1_RST_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin_Pin|SPI1_RST_Pin;
