...
Application for NUCLEO-U575ZI-Q with X-NUCLEO-BNRG2A1 and X-NUCLEO-IKS01A3 expansion boards.
...
1) There is an hardware conflict between the X-NUCLEO-IKS01A3 expansion board and the X-NUCLEO-BNRG2A1 for SPI clock signal.
   The hardware conflict is onto pin 4 of the CN9 arduido connector.
   Open the solder bridges SB39 before to connect the board  X-NUCLEO-IKS01A3.
