...
#define MEMS_ACC_INT_Pin GPIO_PIN_14
#define MEMS_ACC_INT_GPIO_Port GPIOF
#define MEMS_ACC_INT_EXTI_IRQn EXTI14_IRQn
...
#define PSI1_RST_Pin GPIO_PIN_8
#define PSI1_RST_GPIO_Port GPIOA
