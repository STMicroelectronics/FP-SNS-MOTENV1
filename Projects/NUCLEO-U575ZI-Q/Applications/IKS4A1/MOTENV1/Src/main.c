...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin|PSI1_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI1_CS_Pin PSI1_RST_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin|PSI1_RST_Pin;
